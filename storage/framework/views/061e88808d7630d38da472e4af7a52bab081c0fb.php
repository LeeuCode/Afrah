...
<?php $__env->startSection('container'); ?>
    ...
    <div class="col-xs-12">
        <form action="<?php echo e(url('copying/store')); ?>" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group" >
                ...
                <div class="col-sm-3">
                    <select name="bill_id" type="text" id="bill-id" class="form-control">
                        ...
                        <?php $__currentLoopData = $bills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
...
<?php $__env->startSection('custom-script'); ?>
    ...
    (function($) {
        ...
        $('#bill-id').on('change',function() {
            ...
            $.get('<?php echo e(url('getBill/items/')); ?>/'+id, function(data){
                $('#item-id').html(data);
            });
        });
