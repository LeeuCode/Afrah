                ...
                <tbody class="table">
                    <?php $__currentLoopData = $bills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bill): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($bill->agentName); ?></td>
                            <td><?php echo e($bill->paid); ?>ج</td>
                            <td><?php echo e($bill->turnover); ?>ج</td>
                        </tr>
                        <?php 
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody class="table">
                    ...
                    <?php $__currentLoopData = $remainders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $remainder): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <tr>
                            <td ><?php echo e($remainder->bill->id); ?></td>
        ...
        <div class="col-md-12 col-xs-12">
            <table class="table table-bordered table-hover">
                <tbody class="table">
                    ...
                    <?php endif; ?>
                    <tr>
                        <th colspan="2" class="text-center" >إجمالي المبلغ بخزينة الاستوديو <h3><?php echo e($billTotal + $rmTotal); ?>ج</h3></th>
                    </tr>
                </tbody>
            </table>
        </div>
