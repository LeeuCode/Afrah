...
@section('container')
    ...
    <div class="container-fluid">
        <div class="row">
                        ...
                        <div class="widget-main" style="overflow: auto">
                            <div class="col-md-2 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input disabled type="text" class="form-control text-center" id="daily-counter" value="{{ $dayCounter }}">
                                </div>
                                {{-- /.Daily Counter --}}
                            </div>
                            ...
                            <div class="col-md-2 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input disabled type="text" class="form-control text-center" id="id-bill" value="{{ $lastID }}">
                                </div>
                                {{-- /.ID Bill --}}
                            </div>
                        ...
                        <div class="widget-main" style="overflow: auto">
                            <div class="col-md-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input disabled type="text" class="form-control" id="release-date" value="{{ date('Y-m-d') }}" >
                                </div>
                                {{-- /.Release Date --}}
                            </div>
                            ...
                            <div class="col-md-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control date-picker" id="delivery-date" value="{{ date('Y-m-d') }}" >
                                </div>
                                {{-- /.Delivery Date --}}
                            </div>
                        </div>
            ...
            <form id="save-bill" class="form-horizontal" action="{{ url('bill/save') }}" method="POST">
                {{ csrf_field() }}
                    ...
                    <div class="widget-body">
                        <div class="widget-main" style="overflow: auto">
                            ...
                            <div class="col-md-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    {{-- <label for="item-price" style="display: block;color: transparent;">الكمية</label> --}}
                                    <button class="btn btn-success btn-block btn-xs save-bill" style="padding: 4px 6px 5px;">
                                        <i class="ace-icon fa fa-plus align-top bigger-125"></i>
                                        حافظ الفاتورة
                                    </button>
                                </div>
    ...
    <script>
        (function($) {
            ...
            $('#item-name').on('change',function (){
                ...
                if(id != null) {
                    $.get("{{ url('getItem') }}/"+id, function(data, status){
            ...
            $('#item-quantity').on('keypress keyup keydown change', function () {
               total(); 
            });
            ...
            // balanceTotal
            $('#paid').on('keypress keydown keyup change', function() {
                balanceTotal();
            });
            ...
            $(document).on('click','.print-btn',function(){
                ...
                $('#print-bill').printThis({
                    ...
                    loadCSS: ["{{ asset('assets/css/ace.min.css') }}","{{ asset('public/assets/css/ace-rtl.min.css') }}"],                // path to additional css file - use an array [] for multiple
                ...
                if ($('.append-item tr').length > 0) {
                    $.post(url, data, function(data, status){
                        ...
                        $('#print-bill').printThis({
                            ...
                            importStyle: true,         // import style tags
                            printContainer: true,       // print outer container/$.selector
                            loadCSS: ["{{ asset('/assets/css/ace.min.css') }}","{{ asset('assets/css/ace-rtl.min.css') }}"],                // path to additional css file - use an array [] for multiple
                            pageTitle: "",              // add title to print page
                            removeInline: false,        // remove inline styles from print elements
                            removeInlineSelector: "*",  // custom selectors to filter inline styles. removeInline must be true
